CREATE TABLE IF NOT EXISTS hw_two_six_data (
    performance_id VARCHAR(100) NOT NULL COMMENT '业绩ID',
...
CREATE TABLE IF NOT EXISTS hw_two_five_data_smbcore (
    performance_id VARCHAR(100) NOT NULL COMMENT '业绩ID',
    sales_amount DECIMAL(16,2) COMMENT '业绩金额(¥)',
    performance_date DATE COMMENT '业绩形成时间',
	special_rebate_type VARCHAR(255) COMMENT '特殊返点类型',
...
COMMENT='25年业绩表SMBcore';

 CREATE TABLE IF NOT EXISTS hw_two_five_data_na (
